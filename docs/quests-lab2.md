...
### what if a task returns (optional for CS4414; required for CS6456)? 
...
- CS4414 students: submit it along this quest's other deliverable.
- CS6456 students: include the answer in your one-page writeup for the whole lab.
https://github.com/fxlin/uva-os-main/blob/main/docs/syllabus-25sp.md#requirements-for-cs6456-students
